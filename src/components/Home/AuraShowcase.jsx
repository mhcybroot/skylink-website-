...
import { Sparkles, Activity, ShieldCheck, Clock, Server, CheckCircle, TrendingUp, Cpu, Cloud, Terminal } from 'lucide-react';
    ...
    return (
        <section className="relative py-28 md:py-36 bg-black text-white px-6 overflow-hidden border-t border-white/[0.06]">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="aura-glass-card border border-white/10 p-6 md:p-10 shadow-2xl relative overflow-hidden bg-zinc-950/70">
                    {/* Top Bar of Cockpit */}
