...
const EnterpriseClientMarquee = () => {
    return (
        <div className="relative py-12 bg-black border-y border-white/[0.08] overflow-hidden select-none">
            ...
            <div className="absolute inset-y-0 left-0 w-24 sm:w-48 bg-gradient-to-r from-black via-black/80 to-transparent z-20 pointer-events-none" />
            <div className="absolute inset-y-0 right-0 w-24 sm:w-48 bg-gradient-to-l from-black via-black/80 to-transparent z-20 pointer-events-none" />
            ...
            <div className="flex overflow-hidden mb-4 group">
                ...
                >
                    {[...track1, ...track1].map((client, idx) => (
                        <div
                            key={idx}
                            className="flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-zinc-950/80 border border-white/10 hover:border-[#00E5BE]/50 hover:bg-zinc-900 transition-all backdrop-blur-md shrink-0 shadow-sm cursor-default"
                        >
                            <div className="w-2 h-2 rounded-full bg-[#00E5BE] shadow-[0_0_8px_#00E5BE] shrink-0" />
                            <span className="text-xs sm:text-sm font-bold text-slate-200 hover:text-white font-sans whitespace-nowrap">
                                {client.name}
                            </span>
                            <span className="text-[10px] font-mono uppercase px-2 py-0.5 rounded bg-white/5 border border-white/10 text-slate-400 shrink-0">
                                {client.type}
                            </span>
                        </div>
                    ))}
            ...
            {/* Track 2: Rightward Infinite Motion */}
